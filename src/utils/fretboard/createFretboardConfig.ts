...
import {
  fretboardIconNames,
  isProportionalFretboardIcon,
  type FretboardIcon,
} from "@/data/fretboard/icons";
import {
...
function getDefaultStringWidth(
  stringIndex: number,
  stringCount: number,
  instrument: StringInstrumentKey,
) {
...
function hasCustomProportionalInlaySize(value: unknown) {
  return normalizeString(value) !== undefined;
}

function getDefaultProportionalInlaySize(
